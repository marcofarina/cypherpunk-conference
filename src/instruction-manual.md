...
// incoming transmission 0xC1PH3R — last message: 2026-03-10 09:17 //

Se stai leggendo queste righe, vuol dire che sono scomparso.

Non so quanto tempo mi resta prima che trovino anche questo canale — forse ore, forse è già troppo tardi. Quello che so è che non sono stati i federali a trovarmi. I federali fanno rumore, mandano lettere, bussano alla porta alle sei di mattina. Questi no. Questi ti cancellano: prima i nodi, poi i server, poi le persone.

Per anni ho costruito strumenti che nessuno avrebbe dovuto poter spegnere. Ho scritto codice che gira su macchine che non conosco, in paesi che non ho mai visitato. Ho creduto che bastasse. Mi sbagliavo. Non puoi difendere una rete se sei l'unico a conoscerne le chiavi.

Ecco perché ho diviso tutto. Il mio wallet contiene quello che resta del mio lavoro — non molto in termini di denaro, ma è la prova che il sistema funziona, che nessuno può confiscarlo, che il codice sopravvive a chi lo scrive. Ho nascosto le dodici parole della seed phrase in luoghi diversi: dentro cifrari, in file protetti, tra le righe di testi che solo chi capisce può leggere. Alcuni indizi li ho lasciati sulla rete, altri sono nei fogli che hai davanti.

Non mi fido di nessuno in particolare, ma mi fido della matematica. Se riesci a risolvere tutti gli indovinelli, ricostruirai la frase e aprirai il wallet. A quel punto i satoshi saranno tuoi — trasferiscili prima che qualcun altro ci arrivi.

Un'ultima cosa. Ogni enigma produce una parola: a volte direttamente, a volte come numero che corrisponde a una posizione nella lista. La lista BIP-39 è inclusa nei materiali.

Il tempo non è dalla tua parte. Non è mai dalla parte di nessuno.
...
seed02
INTERCETTAZIONE № 7-B — SEGNALE ATTIVO

Le stazioni di ascolto che ho lasciato attive agganciano un segnale codificato su una frequenza non protetta. Il segnale è in loop, ma la finestra di trasmissione è breve — tre ripetizioni, poi il canale si chiude. Dovete riagganciarlo se non fate in tempo a decodificarlo.
Accedete al ricevitore in remoto da un vostro terminale:

Sono costretto ad usare protocolli di comunicazione analogici per sfuggire alla sorveglianza digitale. Le mie trasmissioni precedenti sono sempre state su canali audio a bassa potenza — i nostri alleati in campo operano esclusivamente con auricolari e dispositivi con l'audio attivo al massimo per non perdere segnali deboli. Sei all’altezza del compito?
...
========================================================================
[INTERCEPT — CANALE 7F2A — TIMESTAMP CORROTTO]

> 0xC1PH3R:

La macchina è pronta. Ho caricato tre registri e li ho bloccati. Senza la configurazione giusta non ne esce niente di utile.

Le chiavi di rotazione sono nelle prime tre parole che hai già recuperato. Ogni parola ha un indice — lo sai, è la sua posizione nella lista. Prendi quell'indice e riducilo. Somma le cifre, poi somma ancora, finché non resta un numero solo. Quello è lo scorrimento del rotore corrispondente: prima parola, primo rotore. Seconda, secondo. Terza, terzo.

Per l'operazione logica è ancora più semplice. Prendi l'indice della quarta parola e dividilo per 3. Non ti serve il risultato — ti serve il resto. Quello è il codice dell'operazione. La macchina li mostra già numerati.
Se hai fatto tutto giusto, la macchina parla da sola.
